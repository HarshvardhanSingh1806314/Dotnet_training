...
namespace Assignment_4
{
    ...
    class NegativeCreditAmountException : ApplicationException
    {
        public NegativeCreditAmountException(string message) : base(message) { }
    }
    ...
    internal class Accounts
    {
        ...
        private bool Credit(int amount)
        {
            try
            {
                ...
                {
                    throw new NegativeCreditAmountException("You cannot deposit negative amount");
                }
            } catch (NegativeCreditAmountException)
            {
                return false;
            }
        }
